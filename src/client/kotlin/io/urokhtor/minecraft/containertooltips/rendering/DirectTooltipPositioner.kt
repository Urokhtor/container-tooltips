...
/**
 * Implementation of [ClientTooltipPositioner] that does not adjust tooltip position in any way. In this mod's case we want to
 ...
 * y position.
 */
class DirectTooltipPositioner : ClientTooltipPositioner {
    override fun positionTooltip(screenWidth: Int, screenHeight: Int, x: Int, y: Int, width: Int, height: Int): Vector2ic {
        return Vector2i(x, y)
    }
}
